...
const CreateEvent = () => {
    ...
    const onClickDemoBtn = () => {
        setFormData({
            title: "Rhythm Bloom: Music in Motion",
            description:
                "Rhythm Bloom is a vibrant celebration of music, movement, and culture. Featuring live bands, DJs, dance zones, and art, it’s where melodies blossom and the crowd becomes the heartbeat.",
            about: `Rhythm Bloom is an open-air, genre-spanning music festival that transforms everyday spaces into a playground of rhythm, dance, and visual storytelling. It brings together rising stars, underground acts, and headliners across pop, electronic, indie, and world music scenes.

Beyond the music, the event features dance workshops, art installations, food markets, and chill-out lounges to create a holistic, immersive vibe. Rhythm Bloom is built for connection — to the beat, to the crowd, and to something greater.

Whether you're dancing under the stars or discovering your new favorite artist, Rhythm Bloom is where sound comes alive.`,
            date: "2025-05-24",
            time: "19:00",
            duration: 3,
            location: "Colombo",
                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        <div className="flex justify-between items-center mb-4">
                            <div>
                                <button
                                    onClick={onClickDemoBtn}
                                    className={
                                        "bg-green-600 text-white hover:bg-green-700 font-medium py-1 px-3 rounded-lg w-auto transition flex items-center justify-center"
                                    }
                                >
                                    Demo
                                </button>
